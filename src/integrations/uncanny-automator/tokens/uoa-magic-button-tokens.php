...
class UOA_Magic_Button_Tokens {
	...
	public function __construct() {
		...
		add_filter( 'automator_maybe_trigger_uoa_wpmagicbutton_tokens', array( $this, 'wp_possible_tokens' ), 20, 2 );
		add_filter( 'automator_maybe_trigger_uoa_wpmagiclink_tokens', array( $this, 'wp_possible_tokens' ), 20, 2 );
