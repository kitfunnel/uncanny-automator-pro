...
class WCM_USERACCESSEXPIRED {
	...
	public function __construct() {
		$this->trigger_code = 'WCMUSERACCESSEXPIRED';
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( esc_attr__( "A user's access to {{a membership plan:%1\$s}} expires", 'uncanny-automator-pro' ), $this->trigger_meta ),
			/* translators: Logged-in trigger - WooCommerce Memberships */
			'select_option_name'  => esc_attr__( "A user's access to {{a membership plan}} expires", 'uncanny-automator-pro' ),
			'action'              => 'wc_memberships_user_membership_status_changed',
			'priority'            => 99,
			'accepted_args'       => 3,
			'validation_function' => array(
				$this,
				'wc_user_membership_expired',
			),
	 ...
	 * @param $new_status
	 */
	public function wc_user_membership_expired( $membership_plan, $old_status, $new_status ) {
